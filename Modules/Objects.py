...
class Character(Object):
    ...
    def __init__(self, objType, name, desc, hp, currentHP, initiative, pos, file):
    ...
    def toJson(self):
        return {"Name" : self.name, "Description" : self.description, "type" : self.objType, "HP" : self.currentHP,
                "MaxHP" : self.hp, "Initiative" : self.initiative, "Position" : self.getPos(), "image file" : self.image}
